...
## Cursor
**Next issue: FMC-4** — queue order confirmed by the user on 2026-07-20 (selected
...
| --- | --- | --- | --- |
| 1 | FMC-4 | bug [MED] | Close sandbox path-existence oracle + extend body-size caps to structured fields |
| 2 | FMC-5 | bug [MED] | Fix Notifier/long-poll correctness bugs in services/store.py (4 sub-bugs; riskiest change — touches core long-poll infra) |
| 3 | FMC-6 | bug [LOW] | Fix tool-pattern deviations from CLAUDE.md's documented contract |
